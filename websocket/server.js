...
function GroupMember(groupId, func) {
            console.log(groupId);
    //sort groupMember:1 ALPHA get # get user:*->nickName get user:*->imageUrl
...
function GroupsList(userId, func) {
    console.log(userId,"groupList");
    //sort groupSet:14006 ALPHA get # get group:*->groupName get group:*->imageUrl
    var args = ['groupSet:' + userId  , 'GET',  '#',  'GET',  'group:*->groupName',  'GET',  'group:*->imageUrl'];
    redisDB.sort( args, function (err, reply) {
...
{
     console.log(userId, "friendsList");
     //can't have space
    //sort friendsSet:chenjianhua ALPHA get # get user:*->nickName get user:*->imageUrl
    var args = ['friendsSet:' + userId , 'ALPHA' ,'GET', '#', 'GET', 'user:*->nickName','GET', 'user:*->imageUrl'];
...
//--------------------------add test data
//user:014006 : password:123456  nickName:aaa  imageurl  url hashMap
//user:014007 : password:123456  nickName:bbb  imageurl   url  hashMap
//friendsSet:014006 :  014007   Set
//friendsSet:014007 :  014006   Set
//groupSet:014006   :  1             Set
//groupSet:014007   :  1             Set
//group:1    groupName:mygroup   List
//groupMember:1   014006 014007  List